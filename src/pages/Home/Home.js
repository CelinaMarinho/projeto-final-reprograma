                ...
                <section className='card-introducao' id="povos-indigenas">
                    <h1 className="titulo">
                        ...
                        <div class="container-texto-paragrafos">
                            <p><span className='span__home'>Gonengo Tiana!</span> Essa saudação, seja bem-vindo, em língua Xukuru, 
                    ...
                    <div class="container-texto">
                            <div className='card-povos'>     
                                ...
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iusto aliquid ad, recusandae laborum sapiente 
                                    ut inventore nihil dolore vel necessitatibus deserunt fugiat, numquam possimus. Quis, odio. Consequatur
                                    unde earum officiis</p>
                                    </div>
                                </div>
                            </div>
                    </div>
